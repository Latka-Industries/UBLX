...
| Catalog search | status strip | landed (`/` + × clear) | — |
| Row marquee | overflowing selected labels | landed (focused pane) | THI-209 |
...
| Viewer find | Shift+S strip | landed (+ × clear) | **11** |
| Viewer fullscreen | Shift+F | landed (Esc / q exit) | THI-210 |
