...
use crate::layout::setup::{
    CATEGORY_DIRECTORY, RightPaneContent, RightPaneContentDerived, SnapshotEntryMeta, TuiRow,
    UblxState, ViewData, ViewerDiskContentCache,
};
...
/// Load zahir JSON text for a snapshot path (empty string if missing).
...
// `sectioned_preview_from_zahir` / scrub helpers live in [`crate::handlers::preview`] (THI-213).
