...
- `GET /content/{*path}` — disk file body for Viewer (`file_content_for_viewer`); `?format=text|html` (default: HTML for Markdown + syntect categories JSON/TOML/YAML/XML/HTML/INI/Log/Code). Path must stay under the current root.
